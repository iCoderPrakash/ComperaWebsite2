...
const Home = () => {
  ...
  useEffect(() => {
    ...
    // Card ScrollTrigger animations (left, right, top)
    gsap.fromTo(
      card1.current,
      { opacity: 0, x: -100 },
      {
        ...
        <div className="container mx-auto px-4 lg:px-8 flex flex-col lg:flex-row items-center justify-between">
          <div className="lg:w-2/3">
            ...
            <p className="text-gray-600 mb-4 mr-4">
             <span className="mb-4 block" > Alok Bhatt is an engineering graduate in computer science with
              over a decade of experience in teaching a variety of emerging
              technologies. His expertise includes Java, Spring, Hibernate,
              JavaScript, Node.js, Python-based frameworks like Django, as well
              as Big Data technologies such as Hadoop, Hive, and Pig. Alok is
              the cofounder of COMPERA COMPUTER EDUCATIONAL SOCIETY, an
              institution dedicated to providing high-quality education in the
              field of computer science.</span> Additionally, Alok is the cofounder of
              M24 TechSpace Private Limited, a company that specializes in
              fintech operations, including the development of web and mobile
              applications. His work has significantly contributed to education
              and technology sectors, particularly in emerging and innovative
              fields.
            </p>
  ...
  <div ref={card1} className="p-4 border border-gray-200 shadow-md">
    <img src={img1} alt="Card 1" className="w-full h-40 object-cover mb-4" />
    <h2 className="text-2xl font-bold mb-2">Django </h2>
    <p>Welcome to the Compera Django Blog, where we deliver tutorials, tips, and insights on Python programming. From beginner basics to advanced concepts, we cover it all to help you level up your skills. Stay tuned for the latest updates and practical coding advice!
    .</p>
  </div>
  <div ref={card2} className="p-4 border border-gray-200 shadow-md">
    <img src={img2} alt="Card 2" className="w-full h-40 object-cover mb-4" />
    <h2 className="text-2xl font-bold mb-2">JAVA </h2>
    <p>Welcome to the Compera Java Blog, your go-to source for expert tips, tutorials, and insights on Java programming. Whether you're a beginner or a pro, we cover everything from core concepts to advanced techniques. Stay updated and enhance your coding skills with our latest posts.
    .</p>
  </div>
  <div ref={card3} className="p-4 border border-gray-200 shadow-md">
    <img src={img3} alt="Card 3" className="w-full h-40 object-cover mb-4" />
    <h2 className="text-2xl font-bold mb-2">HTML</h2>
    <p>Welcome to the Compera HTML Blog, your go-to resource for mastering the fundamentals of web development. Discover tutorials, tips, and best practices to create clean, responsive websites using HTML. Stay updated with the latest trends and techniques in front-end design!
    .</p>
  </div>
</div>
