      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-24">
        <div className="flex flex-col md:flex-row justify-between">
          ...
          <div className="mb-8 md:mb-0 md:w-1/3">
            <h2 className="text-3xl font-bold text-red-600 mb-4">Compera Institute</h2>
            <p className="mb-6">
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-red-600 p-2 rounded-full hover:bg-yellow-400 transition-colors">
                <FaFacebookF size={20} />
              </a>
              <a href="#" className="bg-red-600 p-2 rounded-full hover:bg-yellow-400 transition-colors">
                <FaTimes size={20} />
              </a>
              <a href="#" className="bg-yellow-400 p-2 rounded-full hover:bg-red-600 transition-colors">
                <FaInstagram size={20} />
              </a>
            </div>
          </div>
          ...
          <div className="mb-8 md:mb-0 md:w-1/3">
            <h3 className="text-xl font-semibold text-red-600 mb-4">Services</h3>
          ...
          <div className="md:w-1/3">
            <h3 className="text-xl font-semibold text-red-600 mb-4">Contact Information</h3>
